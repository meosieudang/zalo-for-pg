...
const ModalRequestPermission = React.forwardRef<{ toggle: () => void }, { onAccept: () => void }>(({ onAccept }, ref) => {
        ...
        >
            ...
            <DialogContent>
                ...
                <DialogContentText id="alert-dialog-slide-description">
                    Cho phép truy cập thông tin người dùng, số điện thoại cho CRE Advanced để sử dụng tính năng đổi quà
                </DialogContentText>
            </DialogContent>
            <DialogActions>
